    ...
    return (
        <>
            <div>
                ...
                <p><span style={{fontWeight: "bold"}}>'Cash-poor' people are charged a high ~20% premium</span> to get cash from their credit cards. Get 'cash-rich' for a fraction of that premium through Venmo with a CashClan member - without banks.</p>
            </div>
            <br />
            <br />
            <div align="center">
